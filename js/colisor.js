...
Colisor.prototype = {
    ...
    processar: function(){
        ...
        for(var i in this.sprites){
            for(var j in this.sprites){
                ...
                //Criar arrays se já não existirem
    ...
    processarExclusoes: function() {
        ...
        // Adicionar somente os elementos não excluidos
    ...
    testarColisao: function(sprite1,sprite2) {
        //Obter os retânguolos de colisão de cada sprite
...
Object.defineProperty(Colisor.prototype,"constructor",{
    value: Colisor,
    enumerable: false,
    writable: true
});